...
public class SubmitRequest  implements java.io.Serializable {
    ...
    private openair.wsdl.OaBase submit;

    private openair.wsdl.OaBase approval;
    ...
    public SubmitRequest(
           ...
           openair.wsdl.OaBase submit,
           openair.wsdl.OaBase approval) {
     ...
     * @return submit
     */
    public openair.wsdl.OaBase getSubmit() {
        return submit;
    }
     ...
     * @param submit
     */
    public void setSubmit(openair.wsdl.OaBase submit) {
        this.submit = submit;
    }
     ...
     * @return approval
     */
    public openair.wsdl.OaBase getApproval() {
        return approval;
    }
     ...
     * @param approval
     */
    public void setApproval(openair.wsdl.OaBase approval) {
        this.approval = approval;
    }
