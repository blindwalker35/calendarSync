...
public class RunReportResult  implements java.io.Serializable {
    ...
    /**
     * Gets the status value for this RunReportResult.
     * 
     * @return status   * Status: 1 = success -1 = failure.
     */
    ...
    /**
     * Sets the status value for this RunReportResult.
     * 
     * @param status   * Status: 1 = success -1 = failure.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://namespaces.soaplite.com/perl", "RunReportResult"));
