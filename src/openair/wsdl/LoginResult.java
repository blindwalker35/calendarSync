...
public class LoginResult  implements java.io.Serializable {
    ...
    /**
     * Gets the url value for this LoginResult.
     * 
     * @return url
     */
    ...
    /**
     * Sets the url value for this LoginResult.
     * 
     * @param url
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://namespaces.soaplite.com/perl", "LoginResult"));
