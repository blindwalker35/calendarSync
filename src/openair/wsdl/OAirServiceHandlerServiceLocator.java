...
public class OAirServiceHandlerServiceLocator extends org.apache.axis.client.Service implements openair.wsdl.OAirServiceHandlerService {
    ...
    public openair.wsdl.OAirServiceHandler getOAirService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            openair.wsdl.OAirServiceSoapBindingStub _stub = new openair.wsdl.OAirServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (openair.wsdl.OAirServiceHandler.class.isAssignableFrom(serviceEndpointInterface)) {
                openair.wsdl.OAirServiceSoapBindingStub _stub = new openair.wsdl.OAirServiceSoapBindingStub(new java.net.URL(OAirService_address), this);
                _stub.setPortName(getOAirServiceWSDDServiceName());
                return _stub;
            }
        }
