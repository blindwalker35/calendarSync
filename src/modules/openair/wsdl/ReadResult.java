...
public class ReadResult  implements java.io.Serializable {
    private modules.openair.wsdl.OaBase[] objects;
    ...
    public ReadResult(
           modules.openair.wsdl.OaBase[] objects,
     ...
     * @return objects
     */
    public modules.openair.wsdl.OaBase[] getObjects() {
        return objects;
    }
     ...
     * @param objects
     */
    public void setObjects(modules.openair.wsdl.OaBase[] objects) {
        this.objects = objects;
    }
